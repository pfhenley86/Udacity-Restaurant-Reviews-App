...
take an app and make it fully responsive and accessible to users on different types of devices. 
The App should also be able to work when network connection poor or non-existent.

## Description.

A user can choose from a range of food choices and locations 
and a number of restaurants suggestions appear according those options. 
After choosing a specific restaurant a user receives
info for the restaurant such as address, food, oppening hours,
